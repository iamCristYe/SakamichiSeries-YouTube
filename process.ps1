...
yt-dlp --playlist-start $N_count -f 140 -o '乃木坂46全曲 All Songs from Nogizaka46/%(playlist_index)03d - %(title)s - %(id)s.%(ext)s' "PLslx0ZK4M9ze0MqtIiTguDfmP0eOvdj2i"
# H
$H_count = (Get-ChildItem "日向坂46全曲 All Songs from Hinatazaka46" | Measure-Object).count
yt-dlp --playlist-start $H_count -f 140 -o '日向坂46全曲 All Songs from Hinatazaka46/%(playlist_index)03d - %(title)s - %(id)s.%(ext)s' "PLslx0ZK4M9zertJb1q9I4vL3Z8IMtIw4D"
# S
